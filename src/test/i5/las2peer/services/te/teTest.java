...
/**
 *
 * saveMeAgain - Test Class
 *
 * This class provides a basic testing framework for the microservice saveMeAgain. It was
...
public class teTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(te.class.getCanonicalName(),"0.1");

  private static final String mainPath = "te";
  ...
  public void testasd() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/asd", .toJSONString(),
        MediaType.APPLICATION_JSON, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testasd': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
